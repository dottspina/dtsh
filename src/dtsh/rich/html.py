...
class HtmlFormat:
    ...
    @staticmethod
    def ifind(txt: list[str], pattern: re.Pattern[str], start: int) -> tuple[int, re.Match[str]]:
...
class HtmlDocument:
    ...
    def capture(
        ...
        *,
        ...
        html = console.export_html(theme=theme, code_format=fmt, inline_styles=False)
    ...
    def __init__(self, html: str) -> None:
        ...
        self._codes = HtmlPreformatted.ifind_list(html_lines, self._style.i_end + 1)
    ...
    def content(self) -> str:
        ...
        return DTSH_HTML_OUTPUT_FORMAT.format(
            ...
            pre_codes="\n".join(line for pre in self._codes for line in pre.content),
        )
